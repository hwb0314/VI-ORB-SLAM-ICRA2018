...
% plot yaw
% figure;
subplot(231); grid on; title('Rotation from camera to IMU (Rbc)'); 
hold on; plot(timestamp, yaw_gt, 'k-','LineWidth',2);
hold on; plot(timestamp, yaw, 'r-','LineWidth',2);
...
% figure;
subplot(232); grid on;
hold on; plot(timestamp, pitch_gt, 'k-','LineWidth',2);
hold on; plot(timestamp, pitch, 'r-','LineWidth',2);
% title('pitch')
...
% figure;
subplot(233); grid on;
hold on; plot(timestamp, roll_gt, 'k-','LineWidth',2);
hold on; plot(timestamp, roll, 'r-','LineWidth',2);
% title('roll')
...
% plot x
% figure;
subplot(234); grid on; title('Translation from camera to IMU (Pbc) - after refined');
hold on; plot(timestamp, x_gt, 'k-','LineWidth',2);
hold on; plot(timestamp, x_refined, 'r-','LineWidth',2);
% title('x')
...
% figure;
subplot(235); grid on;
hold on; plot(timestamp, y_gt, 'k-','LineWidth',2);
hold on; plot(timestamp, y_refined, 'r-','LineWidth',2);
% title('y')
...
% figure;
subplot(236); grid on;
hold on; plot(timestamp, z_gt, 'k-','LineWidth',2);
hold on; plot(timestamp, z_refined, 'r-','LineWidth',2);
% title('z')
axis([0 timestamp(end)+5 z_gt(1)-0.5 z_gt(1)+0.5]); 
xlabel('Time (s)'); ylabel('Z (m)');
legend('pre-calibration','estimate','Location','SouthEast','orientation','hor')
